...
/// Native port of `packages/module-timetracker/src/billing/reports/ActivityHeatmapPanel.tsx`.
/// iPhone has no hover — tapping a cell reveals its date/hours in a label
/// above the grid instead of a native tooltip.
